import 'package:Simba/screens/NoImplementedHere/lost_assets/lost_asset_detail.dart';
import 'package:Simba/screens/NoImplementedHere/lost_assets/lost_asset_form.dart';
  ...
  Widget build(BuildContext context) {
    final String assetImageUrl = (asset['image_path'] != null &&
        ...
        ? (asset['image_path'].toString().startsWith('http')
            ? asset['image_path']
            : 'http://192.168.1.7:8000/storage/' + asset['image_path'])
        : '';
