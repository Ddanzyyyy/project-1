...
class Asset {
  ...
  final String assetNo;              // Asset No
  final String generalAccount;       // General Account
  final String subsidiaryAccount;    // Subsidiary Account
  final String category;             // Category
  final String subCategory;          // Sub Category
  final String assetSpecification;   // Asset Specification
  final String assetStatus;          // Asset Status
  final DateTime? acquisitionDate;   // Acquisition Date
  final String aging;                // Aging
  final int quantity;                // Quantity
  final String department;           // Department
  final String controlDepartment;    // Control Department
  final String costCenter;           // Cost Center
  final int available;               // Available
  final int broken;                  // Broken
  final int lost;                    // Lost
